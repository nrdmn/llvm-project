...
class STM8DAGToDAGISelLegacy : public SelectionDAGISelLegacy {
public:
  static char ID;
  STM8DAGToDAGISelLegacy(STM8TargetMachine &TM, CodeGenOptLevel OptLevel)
      : SelectionDAGISelLegacy(
            ID, std::make_unique<STM8DAGToDAGISel>(TM, OptLevel)) {}
};

char STM8DAGToDAGISelLegacy::ID = 0;

FunctionPass *llvm::createSTM8ISelDag(STM8TargetMachine &TM,
                                      CodeGenOptLevel OptLevel) {
    return new STM8DAGToDAGISelLegacy(TM, OptLevel);
}
